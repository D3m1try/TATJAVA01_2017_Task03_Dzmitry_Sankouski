 ...
 */
public abstract class GenericCatalog<T extends Beans> implements Catalog<T> {
    private Class<T> type;
    private boolean isBooksUp = false;
    private Set<Beans> books = new HashSet<>();
    private Set<Beans> savedBooks;
...
//        Beans newBean = BeanFactory.getInstance().;
